<section id="offers" class="py-16 sm:py-24 bg-gray-100 dark:bg-gray-800">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <div class="grid md:grid-cols-2 gap-6 sm:gap-8 mt-10">
      ...
      >
        <h3
          class="text-2xl sm:text-3xl font-bold text-primary-700 dark:text-primary-400 mb-4"
        >
          Commercial Partners
        </h3>
        <p
          class="text-sm sm:text-base text-primary-600 dark:text-primary-300 mb-6"
        >
